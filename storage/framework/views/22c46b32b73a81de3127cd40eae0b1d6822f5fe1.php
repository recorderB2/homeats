<p class="title s-title">
    Why Homeats
</p>
<section class="features">
    <div>
        <img src="<?php echo e(url('images/Homeats/Why Homeats/Plan Your Meals.png')); ?>" alt="feature1">
        <p class="title">
            Plan Your Meals
        </p>
        <p>
    ...
    <div>
        <img src="<?php echo e(url('images/Homeats/Why Homeats/Find the Perfect Meal.png')); ?>" alt="feature3">
        <p class="title">
    ...
    <div>
        <img src="<?php echo e(url('images/Homeats/Why Homeats/Special Orders for Special Occasions.png')); ?>" alt="feature4">
        <p class="title">
    ...
    <div>
        <img src="<?php echo e(url('images/Homeats/Why Homeats/Give Back with Your Order.png')); ?>" alt="feature5">
        <p class="title">
    ...
    <div>
        <img src="<?php echo e(url('images/Homeats/Why Homeats/Order Management.png')); ?>" alt="feature7">
        <p class="title">
            Order Management
        </p>
        <p>
    ...
    <div>
        <img src="<?php echo e(url('images/Homeats/Why Homeats/Real-Time Delivery Tracking.png')); ?>" alt="feature8">
        <p class="title">
    ...
    <div class="penultimate"> 
        <img src="<?php echo e(url('images/Homeats/Why Homeats/Track Your Diet.png')); ?>" alt="feature6">
        <p class="title">
            Track Your Diet
        </p>
        <p>
    ...
    <div class="last">
        <img src="<?php echo e(url('images/Homeats/Why Homeats/Consult with a Dietitian.png')); ?>" alt="feature2">
        <p class="title">
...
</section><?php /**PATH C:\laragon\www\homeats\resources\views/components/feature.blade.php ENDPATH**/ ?>